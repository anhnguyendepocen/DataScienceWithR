...
#### Details
Clustering algorithms provide a Classifcation of data, where the labels are defined as a numeric
vector Cls
Then, a typical cluster-respectively group structure is displayed by the HeatMap function. At the
margin of the heatmap a dendrogram can be shown, if hierarchical cluster algorithms are used.
Here the dendrogram has to be shown separately and only the heatmap itself is displayed [Wilkinson,
2009].
