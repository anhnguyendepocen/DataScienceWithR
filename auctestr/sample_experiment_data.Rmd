...
time indicator for different time points used to build each dataset; these represent dependent observations
of model performance.
model_id Indicator for the statistical algorithm used (this could be ’Logistic Regression’, ’SVM’,
etc.).
...
settings for a given model (i.e., cost for an SVM).
