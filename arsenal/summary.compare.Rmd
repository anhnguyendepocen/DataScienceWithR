...
object An object of class "compare.data.frame", as made by the compare.data.frame
S3 method.
... Other arguments. In print, these are passed to kable.
show.attrs
Logical, denoting whether to show the actual attributes which are different. For
...
Integers denoting the maximum number of differences to report for each of the
three tables. Passing NA will print all differences.32
summary.freqlist
