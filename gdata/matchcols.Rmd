...
This function allows easy selection of the column names of an object using a set of inclusion and
exclusion critera.
...
Vector of column names which match all (method="and") or any (method="or") of the patterns
specified in with, but none of the patterns specified in without.matchcols
Author(s)
